                                ...
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <!-- <form method="post" action="{{ route('delete-party', $party) }}">
                                            ...
                                            <button type="button" class="dropdown-item" onclick="destroyFunction('{{ $party->id }}')"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i>Delete</button>
