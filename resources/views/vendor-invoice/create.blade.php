                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="needs-validation pb-2" method="post" action="{{ route('vendor.store') }}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" name="invoice_no" class="form-control border-bottom" id="validationCustom01">
                                            </div>
