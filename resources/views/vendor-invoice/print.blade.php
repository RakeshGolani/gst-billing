                                    ...
                                    <div class="col-md-4 border p-0">
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                ...
                                                <input type="text" value="{{ $party->full_name }}" style="border: none; line-height: -10;">
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                    ...
                                    <div class="col-md-5 border p-0">
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                ...
                                                <span>{{ $invoice->account_holder_name }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                        ...
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                ...
                                                <span>{{ $invoice->branch_address }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2 pb-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">IFSC Code : </label>
                                                <span>{{ $invoice->ifsc_code }}</span>
                                            </div>
                                            ...
                                            <table class="table mt-4 table-centered border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <b>Web Design</b> <br />
                                                            <span>{{ $invoice->item_description }}</span>
                                                        </td>
